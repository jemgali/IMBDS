...
from .views import UserViewSet, MarkerViewSet, ReportViewSet, BusinessViewSet, InvestibleViewSet 
...
router.register(r'investibles', InvestibleViewSet)  # ✅ ADD THIS (same as businesses)
...
urlpatterns = [
    ...
    # ✅ KEEP existing investible function-based views for compatibility
